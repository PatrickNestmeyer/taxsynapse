...
20                                                                                                        \{
21         
22         \hyperlink{class_reduced_invoice_1_1_a_invoice_a5b51f1865386bd021580507c7133f69a}{Positions}.add(\textcolor{keyword}{new} Position(desc, p, mm, amount, tax, positionerror));
23     \}
\end{DoxyCode}
...
31             \textcolor{keywordflow}{return} \hyperlink{class_reduced_invoice_1_1_a_invoice_a5b51f1865386bd021580507c7133f69a}{Positions}.get(index);               
32     \}
\end{DoxyCode}
...
65                                     \{
66         
67         \textcolor{keywordflow}{return} \hyperlink{class_reduced_invoice_1_1_a_invoice_a5b51f1865386bd021580507c7133f69a}{Positions}.size();
68     \}
\end{DoxyCode}
...
71                                                           \{
72         
73         \hyperlink{class_reduced_invoice_1_1_a_invoice_a5b51f1865386bd021580507c7133f69a}{Positions}.get(index).setDescription(position.getDescription());
74         \hyperlink{class_reduced_invoice_1_1_a_invoice_a5b51f1865386bd021580507c7133f69a}{Positions}.get(index).setPositionPrice(position.getPositionPrice());
75         \hyperlink{class_reduced_invoice_1_1_a_invoice_a5b51f1865386bd021580507c7133f69a}{Positions}.get(index).setAmount(position.getAmount());
76         \hyperlink{class_reduced_invoice_1_1_a_invoice_a5b51f1865386bd021580507c7133f69a}{Positions}.get(index).setTaxrate(position.getTaxrate());
77     \}
\end{DoxyCode}
...
53                                                          \{
54         
55         \hyperlink{class_reduced_invoice_1_1_a_invoice_a5b51f1865386bd021580507c7133f69a}{Positions}.get(index).setAmount(amount);
56     \}
\end{DoxyCode}
...
41                                                                       \{
42         
43         \hyperlink{class_reduced_invoice_1_1_a_invoice_a5b51f1865386bd021580507c7133f69a}{Positions}.get(index).setDescription(description);
44     \}
\end{DoxyCode}
...
47                                                          \{
48         
49         \hyperlink{class_reduced_invoice_1_1_a_invoice_a5b51f1865386bd021580507c7133f69a}{Positions}.get(index).setPositionPrice(price);
50     \}
\end{DoxyCode}
